...
\end{lemma}
\begin{proof}
By Lemma \refbf{horth_coprod}, $\coprod_{i\in\N} \alpha_i,\, \Sigma\coprod_{i\in\N} \alpha_i,\, \Sigma^2\coprod_{i\in\N}\horth \psi$, so it is enough to apply Lemma \refbf{extension}.
\end{proof}
