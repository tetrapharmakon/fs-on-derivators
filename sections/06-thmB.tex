...
This last section of the paper is devoted to introduce all the background needed to discuss, precisely state and, finally, prove \athm \textbf{IV} of the Introduction. First of all, in §\refbf{monads_subs}, we recall from \cite[§\textbf{1}]{lack2002codescent} the relevant definitions of 2-monads and pseudo-algebras. After that, in §\refbf{squaring_subs}, we specialize these general definitions to the so-called squaring monad on $\PDer$. The proof of \athm\@\textbf{IV} will be given at the end of §\refbf{higher_coherence_sub}.
